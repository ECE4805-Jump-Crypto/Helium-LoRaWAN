...
def calculate_reward_unit(num_witnesses):
    #HIP 15 -------------------------------------------------
    ...
    return[total_rx, reward_tx * tx_scale]
...
url = 'https://api.helium.io/v1/blocks/' + str(current_height['height'])
